...
class SQLContext:
    ...
    def getOrCreate(cls: Type["SQLContext"], sc: SparkContext) -> "SQLContext":
        ...
        """
        DeprecatedFuncUsageLogger().log_deprecated(
            "def getOrCreate(cls, sc)", "python/pyspark/sql/context.py"
        )
        warnings.warn(
    ...
    def registerFunction(
        ...
        """
        DeprecatedFuncUsageLogger().log_deprecated(
            "def registerFunction(self, name, f, returnType=None)", "python/pyspark/sql/context.py"
        )
    ...
    def registerJavaFunction(
        ...
        warnings.warn(
            "Deprecated in 2.3.0. Use spark.udf.registerJavaFunction instead.", FutureWarning
        )
...
class HiveContext(SQLContext):
    ...
    def __init__(
        ...
        DeprecatedFuncUsageLogger().log_deprecated(
            "def __init__(self, sparkContext, jhiveContext=None)", "python/pyspark/sql/context.py"
        )
        warnings.warn(
