...
_STREAMINGFOREACHFUNCTION = DESCRIPTOR.message_types_by_name["StreamingForeachFunction"]
...
_STREAMINGQUERYMANAGERCOMMAND_STREAMINGQUERYLISTENERCOMMAND = (
    _STREAMINGQUERYMANAGERCOMMAND.nested_types_by_name["StreamingQueryListenerCommand"]
)
...
_STREAMINGQUERYMANAGERCOMMANDRESULT_STREAMINGQUERYLISTENERINSTANCE = (
    _STREAMINGQUERYMANAGERCOMMANDRESULT.nested_types_by_name["StreamingQueryListenerInstance"]
)
_STREAMINGQUERYMANAGERCOMMANDRESULT_LISTSTREAMINGQUERYLISTENERRESULT = (
    _STREAMINGQUERYMANAGERCOMMANDRESULT.nested_types_by_name["ListStreamingQueryListenerResult"]
)
...
StreamingForeachFunction = _reflection.GeneratedProtocolMessageType(
    "StreamingForeachFunction",
    (_message.Message,),
    {
        "DESCRIPTOR": _STREAMINGFOREACHFUNCTION,
        "__module__": "spark.connect.commands_pb2"
        # @@protoc_insertion_point(class_scope:spark.connect.StreamingForeachFunction)
    },
)
_sym_db.RegisterMessage(StreamingForeachFunction)
...
StreamingQueryManagerCommand = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "StreamingQueryListenerCommand": _reflection.GeneratedProtocolMessageType(
            "StreamingQueryListenerCommand",
            (_message.Message,),
            {
                "DESCRIPTOR": _STREAMINGQUERYMANAGERCOMMAND_STREAMINGQUERYLISTENERCOMMAND,
                "__module__": "spark.connect.commands_pb2"
...
_sym_db.RegisterMessage(StreamingQueryManagerCommand.StreamingQueryListenerCommand)
...
StreamingQueryManagerCommandResult = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "StreamingQueryListenerInstance": _reflection.GeneratedProtocolMessageType(
            "StreamingQueryListenerInstance",
            (_message.Message,),
            {
                "DESCRIPTOR": _STREAMINGQUERYMANAGERCOMMANDRESULT_STREAMINGQUERYLISTENERINSTANCE,
                "__module__": "spark.connect.commands_pb2"
                # @@protoc_insertion_point(class_scope:spark.connect.StreamingQueryManagerCommandResult.StreamingQueryListenerInstance)
            },
        ),
        "ListStreamingQueryListenerResult": _reflection.GeneratedProtocolMessageType(
            "ListStreamingQueryListenerResult",
            (_message.Message,),
            {
                "DESCRIPTOR": _STREAMINGQUERYMANAGERCOMMANDRESULT_LISTSTREAMINGQUERYLISTENERRESULT,
                "__module__": "spark.connect.commands_pb2"
...
_sym_db.RegisterMessage(StreamingQueryManagerCommandResult.StreamingQueryListenerInstance)
_sym_db.RegisterMessage(StreamingQueryManagerCommandResult.ListStreamingQueryListenerResult)
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _STREAMINGQUERYMANAGERCOMMAND._serialized_end = 7122
    ...
    _STREAMINGQUERYMANAGERCOMMAND_STREAMINGQUERYLISTENERCOMMAND._serialized_start = 6906
    _STREAMINGQUERYMANAGERCOMMAND_STREAMINGQUERYLISTENERCOMMAND._serialized_end = 7111
    _STREAMINGQUERYMANAGERCOMMANDRESULT._serialized_start = 7125
    _STREAMINGQUERYMANAGERCOMMANDRESULT._serialized_end = 8201
    _STREAMINGQUERYMANAGERCOMMANDRESULT_ACTIVERESULT._serialized_start = 7733
    _STREAMINGQUERYMANAGERCOMMANDRESULT_ACTIVERESULT._serialized_end = 7860
    _STREAMINGQUERYMANAGERCOMMANDRESULT_STREAMINGQUERYINSTANCE._serialized_start = 7862
    _STREAMINGQUERYMANAGERCOMMANDRESULT_STREAMINGQUERYINSTANCE._serialized_end = 7977
    _STREAMINGQUERYMANAGERCOMMANDRESULT_AWAITANYTERMINATIONRESULT._serialized_start = 7979
    _STREAMINGQUERYMANAGERCOMMANDRESULT_AWAITANYTERMINATIONRESULT._serialized_end = 8038
    _STREAMINGQUERYMANAGERCOMMANDRESULT_STREAMINGQUERYLISTENERINSTANCE._serialized_start = 8040
    _STREAMINGQUERYMANAGERCOMMANDRESULT_STREAMINGQUERYLISTENERINSTANCE._serialized_end = 8115
    _STREAMINGQUERYMANAGERCOMMANDRESULT_LISTSTREAMINGQUERYLISTENERRESULT._serialized_start = 8117
    _STREAMINGQUERYMANAGERCOMMANDRESULT_LISTSTREAMINGQUERYLISTENERRESULT._serialized_end = 8186
    _GETRESOURCESCOMMAND._serialized_start = 8203
    _GETRESOURCESCOMMAND._serialized_end = 8224
    _GETRESOURCESCOMMANDRESULT._serialized_start = 8227
    _GETRESOURCESCOMMANDRESULT._serialized_end = 8439
    _GETRESOURCESCOMMANDRESULT_RESOURCESENTRY._serialized_start = 8343
    _GETRESOURCESCOMMANDRESULT_RESOURCESENTRY._serialized_end = 8439
