...
_DELTATABLE = DESCRIPTOR.message_types_by_name["DeltaTable"]
_DELTATABLE_PATH = _DELTATABLE.nested_types_by_name["Path"]
_DELTATABLE_PATH_HADOOPCONFENTRY = _DELTATABLE_PATH.nested_types_by_name["HadoopConfEntry"]
DeltaTable = _reflection.GeneratedProtocolMessageType(
    "DeltaTable",
    (_message.Message,),
    {
        "Path": _reflection.GeneratedProtocolMessageType(
            ...
            (_message.Message,),
            {
                "HadoopConfEntry": _reflection.GeneratedProtocolMessageType(
                    "HadoopConfEntry",
                    (_message.Message,),
                    {
                        "DESCRIPTOR": _DELTATABLE_PATH_HADOOPCONFENTRY,
                        "__module__": "delta.connect.base_pb2"
                        # @@protoc_insertion_point(class_scope:delta.connect.DeltaTable.Path.HadoopConfEntry)
                    },
                ),
                "DESCRIPTOR": _DELTATABLE_PATH,
                "__module__": "delta.connect.base_pb2"
                # @@protoc_insertion_point(class_scope:delta.connect.DeltaTable.Path)
            },
        ),
        "DESCRIPTOR": _DELTATABLE,
        "__module__": "delta.connect.base_pb2"
        # @@protoc_insertion_point(class_scope:delta.connect.DeltaTable)
    },
)
_sym_db.RegisterMessage(DeltaTable)
_sym_db.RegisterMessage(DeltaTable.Path)
_sym_db.RegisterMessage(DeltaTable.Path.HadoopConfEntry)
